...
export default function EditStudentForm({ student, handleAction }) {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8">
            <Card>
                <CardHeader>
                    <CardTitle>Edit Student: {student.user?.full_name}</CardTitle>
                </CardHeader>
                <CardContent>
                    <form action={handleAction} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t">
                            ...
                            <div>
                                ...
                                <Input name="name" defaultValue={student.user?.full_name || ''} />
                            </div>
                            <div>
                                <label className="block mb-1 font-medium">Email</label>
                                <Input name="email" defaultValue={student.user?.email || ''} />
                            </div>
                            <div>
